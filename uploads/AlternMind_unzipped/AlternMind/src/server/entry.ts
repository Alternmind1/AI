...
// <api-imports>
import ai_generate_post_0 from "./api/ai/generate/POST";
...
import gridspace_companies_get_5 from "./api/gridspace/companies/GET";
import gridspace_companies_post_6 from "./api/gridspace/companies/POST";
import gridspace_companies_id_get_7 from "./api/gridspace/companies/[id]/GET";
import gridspace_facilities_post_8 from "./api/gridspace/facilities/POST";
import gridspace_optimize_get_9 from "./api/gridspace/optimize/GET";
import gridspace_optimize_post_10 from "./api/gridspace/optimize/POST";
import gridspace_suppliers_get_11 from "./api/gridspace/suppliers/GET";
import gridspace_suppliers_optimize_post_12 from "./api/gridspace/suppliers/optimize/POST";
import gridspace_transport_post_13 from "./api/gridspace/transport/POST";
import gridspace_upload_post_14 from "./api/gridspace/upload/POST";
import gridspace_warehouses_post_15 from "./api/gridspace/warehouses/POST";
import health_get_16 from "./api/health/GET";
// </api-imports>
...
// <api-registrations>
app.post("/api/ai/generate", ai_generate_post_0);
...
app.get("/api/gridspace/companies", gridspace_companies_get_5);
app.post("/api/gridspace/companies", gridspace_companies_post_6);
app.get("/api/gridspace/companies/:id", gridspace_companies_id_get_7);
app.post("/api/gridspace/facilities", gridspace_facilities_post_8);
app.get("/api/gridspace/optimize", gridspace_optimize_get_9);
app.post("/api/gridspace/optimize", gridspace_optimize_post_10);
app.get("/api/gridspace/suppliers", gridspace_suppliers_get_11);
app.post("/api/gridspace/suppliers/optimize", gridspace_suppliers_optimize_post_12);
app.post("/api/gridspace/transport", gridspace_transport_post_13);
app.post("/api/gridspace/upload", gridspace_upload_post_14);
app.post("/api/gridspace/warehouses", gridspace_warehouses_post_15);
app.get("/api/health", health_get_16);
// </api-registrations>
